...
class _HabitsScreenState extends State<HabitsScreen> {
    ...
    return Consumer<AppStateManager>(
      builder: (
        ...
        return Scaffold(
          appBar: AppBar(
            title: 
            Image.asset('assets/images/quaso_icone.png', height: 35,),
            backgroundColor: Colors.transparent,
            actions: <Widget>[
              IconButton(
                icon: const Icon(
                  Icons.bar_chart,
                  semanticLabel: 'Estatíticas',
                ),
  ...
  void showRestoreDialog(BuildContext context) {
    AwesomeDialog(
      ...
      title: "Notificações",
      desc: "Quaso precisa de permissão para enviar notificações.",
      btnOkText: "Permitir",
      btnCancelText: "Negar",

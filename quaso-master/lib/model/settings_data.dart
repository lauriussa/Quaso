...
class SettingsData {
  final List<String> themeList = ["Dispositivo", "Light", "Dark"];
  final List<String> weekStartList = ["Se", "Ter", "Qua", "Qui", "Sex", "Sab", "Dom"];
  ...
  Color checkColor = QuasoColors.primary;
  Color failColor = QuasoColors.red;
  Color skipColor = QuasoColors.skip;
